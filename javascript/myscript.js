...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tym t đang đập nhanh vãi m ạ! " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tym t đập nhanh vậy là tại vì!:';
document.querySelector('.Description .modal-body').innerHTML = 'M không cho t ôm m đấy Vinh! <i class="fas fa-heart"></i> ';
